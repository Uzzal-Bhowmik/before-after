  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "focus:ring-ring flex flex-wrap gap-1 rounded-md border border-gray-400 bg-background px-2 py-2 focus-visible:ring-offset-2 focus-visible:ring-offset-primary-blue",
          className,
        )}
        {...props}
      >
...
const MultiSelectorList = forwardRef(({ className, children }, ref) => {
  return (
    <CommandList
      ref={ref}
      className={cn(
        "scrollbar-thumb-muted-foreground absolute top-0 z-10 flex w-full flex-col gap-2 rounded-md border border-muted bg-background bg-white p-2 text-xl shadow-md transition-colors scrollbar-thin scrollbar-track-transparent scrollbar-thumb-rounded-lg dark:scrollbar-thumb-muted",
        className,
      )}
    >
      {children}
  ...
  ({ className, value, label, children, ...props }, ref) => {
    ...
    return (
      <CommandItem
        ...
        className={cn(
          "mb-2 flex cursor-pointer justify-between rounded-md px-2 py-1 text-base transition-colors",
          className,
