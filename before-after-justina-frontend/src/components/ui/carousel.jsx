    ...
    return (
      <div ref={ref} className={`flex justify-center ${props.className}`}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            key={i}
            className={`mx-1 h-[6.5px] w-[6.5px] rounded-full p-0 transition-all duration-300 ease-in-out ${props.btnClass} ${
              i === currentSlide
                ? `w-4 transform rounded-3xl bg-primary-blue hover:bg-primary-blue ${props.activeClass}`
