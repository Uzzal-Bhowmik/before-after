...
const UserCard = ({
  ...
  return (
    <div
      ...
      className={`flex cursor-pointer items-center gap-x-3 rounded-lg px-2 py-3 transition-all duration-300 ease-in-out hover:bg-light-primary-blue ${
        selectedUser?._id === userData?._id && "bg-demin-primary-50"
      }`}
    >
