...
import EditCategoryModal from "./EditSubcategoryModal";
import {
...
export default function SubcategoryContainer() {
  ...
  return (
    <div>
      ...
      <section className="grid grid-cols-1 my-10 gap-7 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        {subcategories.map((subcategory) => (
          <div
            key={subcategory._id}
            className="flex flex-col items-center p-4 border shadow rounded-xl border-primary-blue/25"
          >
            <Image
            ...
            <h4 className="mt-2 mb-5 text-lg">
